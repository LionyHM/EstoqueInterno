...
export default function Modal(props) {
    ...
    async function setProductStorage(){
        ...
        for(let x = 0; x < document.querySelectorAll(".requiredField").length; x++){
          if(document.querySelectorAll(".requiredField")[x].value < 1 || document.querySelectorAll(".requiredField")[x].value == ""){
        ...
        for(let x = 0; x < document.querySelectorAll(".val_reprocess").length; x++){
          if( document.querySelectorAll(".val_reprocess")[x].options[document.querySelectorAll(".val_reprocess")[x].selectedIndex].value == "---")
         {
     ...
     function rec(cd_mvto,cd_product,ds_product,mvtoTotal,mvtoQtd,cd_uni,cd_lote, cd_estoque, dt_validade, val_reprocess){
           fetch("/api/set/setProduct",{
            method: "POST",
            ...
            async function res(response) {
                ...
                document.querySelector("#display_product").insertAdjacentHTML("afterbegin", `
                  ...
                  for(let i = 0; i < document.querySelectorAll(".val_reprocess").length; i++){
                   let element = document.querySelectorAll(".val_reprocess")
